...
updated: 2026-01-08
draft: false
slug: the-augmented-product-manager
description: A practical story on using AI to move from a cloud networking data challenge to a working product.
excerpt: Recovering from shoulder surgery with one arm in a sling, I was already feeling sidelined when a friend hit me with a concrete challenge: Can we visualize data from PeeringDB.com in a way that reveals how companies actually interconnect, without days of manual work?
hero_image: journey.png
hero_alt: Visual journey of the augmented product manager
tags:
  - cloudnetworking
  - AI
  - blog
...
![PeeringDB homepage showing the interconnection database overview](peeringdb.png)
...
![Three-step process for using AI as a product management tool](Three-step_process_for_using_AI_as_a_PM_tool.png)
...
This approach is not limited to PeeringDB or interconnection data. Any Product Manager working with complex, structured datasets, cloud usage, telemetry, pricing, or reference data can adopt the same pattern to move faster and answer harder questions.
...
3. **Measure impact intentionally**
    ...
    - Subjective mental bandwidth: how often you stay focused on strategy instead of wrangling tools.
